...
class GroupedQueryAttention(nn.Module):
    """Grouped Query Attention (GQA). n_head Q heads, n_kv_head K/V heads (1 < n_kv_head < n_head)."""
    ...
    def __init__(self, config):
        ...
        self.n_head_groups = config.n_head // config.n_kv_head
        self.head_dim = config.n_embd // config.n_head
        self.n_embd = config.n_embd
        self.dropout = config.dropout
        # Q projection for all heads, K/V projections only for kv heads
...
class MultiQueryAttention(GroupedQueryAttention):
    """Multi-Query Attention (MQA). n_head Q heads, 1 K/V head. Special case of GQA."""
